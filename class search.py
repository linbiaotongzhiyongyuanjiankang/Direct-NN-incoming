...
class playsearch:
    ...
    def __init__(self, background, aim, sep, step):
    ...
    def play(self):
        ...
        goal_0 = skf(self.background, self.object)
        goal_1 = sepr(self.sep, goal_0)
        goal_2 = possi_route(goal_1, self.step, self.record)
        goal_3 = knockout(goal_2, self.count)
